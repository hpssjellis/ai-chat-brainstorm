    ...
    <div>
      ...
      <div id="myInputArea">
        <div class="my-input-row">
          <input id="myMsg" type="text" class="my-input" placeholder="Share your idea… (Enter to send)" onkeydown="if(event.key==='Enter'&&!event.shiftKey){event.preventDefault();mySend();}">
